...
<template>
  <section class="flex flex-col sm:flex-row sm:justify-between items-center">
    <div class="sm:flex-1 sm:mr-12 sm:max-w-lg" data-aos="fade">
      ...
      <ul
        class="flex flex-wrap bg-white bg-opacity-5 p-2 rounded-md list-disc list-inside mb-2 md:ml-10"
      >
        <li
          v-for="tech in techs"
          :key="'tech-' + tech"
    ...
    <div class="relative h-52 w-52 mt-16 lg:w-72 lg:h-72" data-aos="fade">
      ...
      >
        <div class="relative w-52 h-52 lg:w-72 lg:h-72">
          <div
            class="absolute inset-0 bg-primary bg-opacity-50 hover:bg-opacity-0 z-30 rounded-lg transition-all"
          />

          <img
            class="absolute inset-0 w-52 h-52 object-cover lg:w-72 lg:h-72 object-center rounded-lg saturate-0"
